...
const lightInputStyle = {
  ...
  border: `1px solid ${C.ivoryDark}`, borderRadius: 2, color: C.charcoal,
  fontSize: 14, fontFamily: "Georgia, serif", letterSpacing: 0.5,
  outline: "none", boxSizing: "border-box", display: "block",
};
const btnPrimary = {
  marginTop: 0, padding: "12px 28px", background: C.goldDark,
  color: C.charcoal, border: "none", borderRadius: 2, fontSize: 12,
  fontFamily: "Georgia, serif", letterSpacing: "3px",
  cursor: "pointer", fontWeight: "bold",
};
const btnSmall = {
  padding: "8px 16px", background: C.ivory, border: `1px solid ${C.ivoryDark}`,
...
// Delete link — used ONLY in the expanded lender card bottom row
const deleteLink = {
...
// ─────────────────────────────────────────────────────────────
// PCB Logo — PNG file from public/pcb-logo.png
// Applies gold CSS filter on dark backgrounds (header, login, splash)
// ─────────────────────────────────────────────────────────────
  ...
  return (
    <img
      ...
      style={{
        ...
        display: "block",
        objectFit: "contain",
        // On dark backgrounds render logo in warm gold tones
        filter: darkBg
...
// ─────────────────────────────────────────────────────────────
// Delete Confirm Modal — logo in header, clean layout
// ─────────────────────────────────────────────────────────────
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Real PNG logo — gold-tinted for dark bg */}
...
// ─────────────────────────────────────────────────────────────
// Login Screen
// Fields are BLANK by default. Password has eye-toggle.
// ─────────────────────────────────────────────────────────────
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            color: C.gold, letterSpacing: "5px",
        ...
        <div style={{ marginBottom: 14 }}>
          <div style={{ ...labelStyle, color: `${C.gold}99`, marginBottom: 7 }}>
            EMAIL ADDRESS
          </div>
          <input
            type="email"
        ...
        <div>
          ...
          <div style={{ position: "relative" }}>
            ...
            <button
              ...
              onMouseLeave={e => (e.currentTarget.style.color = `${C.gold}88`)}
...
function Header({ user, onLogout, onHome }) {
  return (
    <header style={{
      ...
      {/* PNG logo — clickable, gold-tinted */}
      <div style={{ cursor: "pointer", display: "flex", alignItems: "center" }} onClick={onHome}>
    ...
    <div style={{ padding: "32px 24px", maxWidth: 1100, margin: "0 auto" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 12, color: C.gold, opacity: 0.6, marginTop: 4 }}>
            Avg Rate:{" "}
            {(lenders.reduce((a, l) => a + l.rate, 0) / (lenders.length || 1)).toFixed(2)}%
          </div>
        </div>
      </div>
      ...
      {recentLenders.map(l => (
        <div key={l.id} style={{
          ...
          padding: "15px 20px", marginBottom: 8, display: "flex",
...
// ─────────────────────────────────────────────────────────────
// Location Select
// — "Delete" link per location and "Delete all in category" REMOVED
// ─────────────────────────────────────────────────────────────
  ...
  return (
    <div style={{ padding: "32px 24px", maxWidth: 900, margin: "0 auto" }}>
      ...
      <div style={{
        ...
        {locs.map(loc => (
          // Clean card — no delete options here
          <div
            key={loc}
      ...
      {/* "Delete all in category" intentionally removed per requirements */}
    </div>
  );
}
...
// ─────────────────────────────────────────────────────────────
// Lender Card
// — Header-row Delete button REMOVED
// — "Delete all" in list header REMOVED
// — Only the bottom-row "Delete" (inside expanded panel) is kept
// ─────────────────────────────────────────────────────────────
  ...
  return (
    <>
      <div style={{
        ...
        {/* ── Card header row — NO delete button here ── */}
        <div
          style={{
        ...
        {expanded && (
          <div style={{ padding: "4px 20px 22px", borderTop: `1px solid ${C.ivory}` }}>
            ...
            {/* ── Bottom action row — Edit + Delete (KEPT here only) ── */}
            <div style={{
              display: "flex", alignItems: "center",
              gap: 20, marginTop: 18,
              paddingTop: 16, borderTop: `1px solid ${C.ivory}`,
            }}>
              <button
              ...
              {/* Delete — only location per requirements */}
              <button
...
// ─────────────────────────────────────────────────────────────
// Lender List
// — "Delete all" link in heading row REMOVED
// ─────────────────────────────────────────────────────────────
function LenderList({ lenders, category, location, onEdit, onDelete, onAdd, onBack }) {
  ...
  return (
    <div style={{ padding: "32px 24px", maxWidth: 1000, margin: "0 auto" }}>
      ...
      {/* Heading row — Add button only, no bulk delete */}
      <div style={{
        ...
        {/* Only Add Lender — "Delete all" intentionally removed */}
        <button
          onClick={onAdd}
          style={btnPrimary}
        >
    ...
    <div style={{ padding: "32px 24px", maxWidth: 1000, margin: "0 auto" }}>
      ...
      <div style={{
        ...
        <input
          ...
          style={{ ...lightInputStyle, marginBottom: 12 }}
        />
    ...
    <div style={{ padding: "32px 24px", maxWidth: 700, margin: "0 auto" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
          ...
          <div>
            ...
            <select
              ...
              onChange={e => set("brokerType", e.target.value)}
              style={{ ...selectStyle, width: "100%", boxSizing: "border-box" }}
            >
        ...
        <div style={{
          ...
          <button
            onClick={onCancel}
            style={{ ...btnSmall, padding: "11px 22px" }}
          >
            CANCEL
          </button>
        </div>
