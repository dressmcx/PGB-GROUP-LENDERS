...
const INITIAL_LENDERS = [
  {
    ...
    brokerType: "Direct Lender",
    notes: "Excellent rates for jumbo loans. Preferred partner.",
  ...
  },
  {
    ...
    brokerType: "Correspondent",
    notes: "Strong in commercial permanent financing.",
  ...
  },
  {
    ...
    brokerType: "Portfolio Lender",
    notes: "Fast close, 30-day guarantee. Great for value-add.",
  ...
  },
  {
    ...
    assistantPhone: "", assistantName: "",
    brokerType: "Direct Lender",
    notes: "Specializes in multifamily bridge-to-perm.",
  ...
  },
  {
    ...
    brokerType: "Construction Specialist",
    notes: "Interest reserve required. 18-month max term.",
  ...
  },
  {
    ...
    assistantPhone: "", assistantName: "",
    brokerType: "Bank",
    notes: "SBA preferred lender. Owner-occ commercial only.",
...
const inputDark = {
  ...
  background: "#2a2a2a", border: `1px solid ${C.goldDark}44`,
  borderRadius: 2, color: C.ivory, fontSize: 14,
  fontFamily: "Georgia, serif", letterSpacing: 0.5,
  outline: "none", boxSizing: "border-box", display: "block",
};
const inputLight = {
  width: "100%", padding: "13px 16px",
  background: C.bg, border: `1px solid ${C.ivoryDark}`,
  borderRadius: 2, color: C.charcoal, fontSize: 14,
  fontFamily: "Georgia, serif", letterSpacing: 0.5,
  outline: "none", boxSizing: "border-box", display: "block",
};
const btnGold = {
  padding: "12px 28px", background: C.goldDark,
  color: C.charcoal, border: "none", borderRadius: 2,
  fontSize: 12, fontFamily: "Georgia, serif",
  letterSpacing: "3px", cursor: "pointer", fontWeight: "bold",
};
const btnLight = {
  padding: "11px 22px", background: C.ivory,
...
// ─────────────────────────────────────────────────────────────
// PCB LOGO  (public/pcb-logo.png)
// darkBg=true applies a gold CSS filter for dark backgrounds
// ─────────────────────────────────────────────────────────────
  ...
  return (
    <img
      ...
      style={{
        ...
        filter: darkBg
          ? "brightness(0) invert(1) sepia(1) saturate(1.1) hue-rotate(3deg) opacity(0.90)"
          : "none",
      }}
    />
  );
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          background: C.charcoal, padding: "20px 24px",
        ...
        <div style={{ padding: "28px 32px" }}>
          ...
          <p style={{
            color: "#666", fontSize: 13, lineHeight: 1.65,
          ...
          <div style={{ display: "flex", gap: 10 }}>
            ...
            <button onClick={onConfirm} style={{
              flex: 1, padding: "11px", background: C.danger,
              border: "none", borderRadius: 2, cursor: "pointer",
              fontSize: 11, letterSpacing: 2,
              fontFamily: "Georgia, serif", color: "white", fontWeight: "bold",
            }}>DELETE</button>
          </div>
        </div>
      </div>
...
function SplashScreen({ onEnter }) {
  ...
  return (
    <div style={{
      ...
      zIndex: 1000,
      opacity: fadeOut ? 0 : 1, transition: "opacity 0.7s ease",
    }}>
      <div style={{
        opacity: visible ? 1 : 0,
        ...
        <PCBLogo size={260} darkBg />
        <div style={{ width: 56, height: 1, background: C.gold, opacity: 0.45 }} />
        <div style={{
          color: C.ivoryDark, letterSpacing: "4px",
...
// ─────────────────────────────────────────────────────────────
// LOGIN SCREEN
// Blank fields, password eye-toggle
// ─────────────────────────────────────────────────────────────
function LoginScreen({ onLogin }) {
  ...
  const handleSubmit = () => {
    ...
    setTimeout(() => {
      if (
        email.trim().toLowerCase() === "yfried@pcgroupny.com" &&
        password === "pcb2027"
      ) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: "#222", borderRadius: 2, padding: "44px 40px",
        ...
        <div style={{
          ...
          <PCBLogo size={210} darkBg />
          <div style={{ color: C.gold, letterSpacing: "5px", fontSize: 10, opacity: 0.75 }}>
        ...
        <div style={{ marginBottom: 14 }}>
          <div style={{ ...fieldLabel, color: `${C.gold}99`, marginBottom: 7 }}>
            EMAIL ADDRESS
          </div>
          <input
            type="email"
        ...
        <div>
          ...
          <div style={{ position: "relative" }}>
            <input
              ...
              style={{ ...inputDark, paddingRight: 48 }}
            />
            <button
              type="button"
        ...
        {error && (
          <div style={{ color: "#e07070", fontSize: 12, marginTop: 12 }}>{error}</div>
        )}
        ...
        <button
          ...
          disabled={loading}
          style={{
            ...btnGold, width: "100%", marginTop: 22,
            padding: "14px", letterSpacing: "3px", fontSize: 13,
          }}
        >
        ...
        <div style={{
          ...
          color: C.gold, opacity: 0.3, fontSize: 10, letterSpacing: 2,
        }}>
  ...
  return (
    <header style={{
      ...
      <div style={{ cursor: "pointer" }} onClick={onHome}>
        <PCBLogo size={115} darkBg />
      </div>
      <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
        <span style={{ color: C.gold, fontSize: 11, letterSpacing: 2, opacity: 0.75 }}>
          {user.name.toUpperCase()}
        </span>
        <button onClick={onLogout} style={{
          background: "transparent", border: `1px solid ${C.goldDark}55`,
          color: C.gold, padding: "6px 18px", borderRadius: 2,
...
function Breadcrumb({ items, onNavigate }) {
  return (
    <div style={{
      color: "#bbb", fontSize: 11, letterSpacing: 1,
      marginBottom: 24, display: "flex", alignItems: "center", gap: 6,
    }}>
      <span
        style={{ cursor: "pointer", color: C.goldDark }}
        onClick={() => onNavigate && onNavigate()}
      >Dashboard</span>
      {items.map((item, i) => (
        <span key={i} style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <span style={{ color: "#ccc" }}>›</span>
          <span style={{ color: i === items.length - 1 ? C.charcoal : C.goldDark }}>
            {item}
          </span>
        </span>
      ))}
...
function Dashboard({ lenders, onCategorySelect }) {
  const stats = CATEGORIES.map(cat => ({
    ...
    avgRate:
      lenders.filter(l => l.category === cat).reduce((a, l) => a + l.rate, 0) /
      (lenders.filter(l => l.category === cat).length || 1),
  }));
  const recent = [...lenders].slice(-3).reverse();

  return (
    <div style={{ padding: "32px 24px", maxWidth: 1100, margin: "0 auto" }}>
      <div style={{ marginBottom: 32 }}>
        <div style={{ color: C.goldDark, fontSize: 10, letterSpacing: 4, marginBottom: 6 }}>
          OVERVIEW
        </div>
        <h1 style={{
          color: C.charcoal, margin: 0, fontSize: 27,
      ...
      <div style={{
        ...
        {stats.map(s => (
          <div key={s.cat} onClick={() => onCategorySelect(s.cat)} style={{
            ...
            borderRadius: 2, padding: "22px 20px", cursor: "pointer",
          }}>
            <div style={{ color: C.goldDark, fontSize: 10, letterSpacing: 3, marginBottom: 8 }}>
              {s.cat.toUpperCase()}
            </div>
            <div style={{ fontSize: 30, fontWeight: "bold", color: C.charcoal, fontFamily: "Georgia, serif" }}>
              {s.count}
            </div>
            <div style={{ fontSize: 12, color: "#888", marginTop: 4 }}>
              Avg Rate: {s.avgRate.toFixed(2)}%
            </div>
            <div style={{ color: C.gold, fontSize: 11, marginTop: 12, letterSpacing: 1 }}>
              View Lenders →
            </div>
          </div>
        ))}
        <div style={{
          background: C.charcoal, borderRadius: 2,
          padding: "22px 20px", borderLeft: `4px solid ${C.goldDark}`,
        }}>
          <div style={{ color: C.gold, fontSize: 10, letterSpacing: 3, marginBottom: 8 }}>
            TOTAL LENDERS
          </div>
          <div style={{ fontSize: 30, fontWeight: "bold", color: C.ivory, fontFamily: "Georgia, serif" }}>
            {lenders.length}
          </div>
      ...
      {/* Recent lenders */}
      <div style={{ color: C.goldDark, fontSize: 10, letterSpacing: 4, marginBottom: 16 }}>
        RECENT LENDERS
      </div>
      {recent.map(l => (
        <div key={l.id} style={{
          background: "white", border: `1px solid ${C.ivoryDark}`,
          borderRadius: 2, padding: "15px 20px", marginBottom: 8,
          display: "flex", alignItems: "center",
          justifyContent: "space-between", flexWrap: "wrap", gap: 8,
        }}>
          <div>
            <div style={{ fontWeight: "bold", color: C.charcoal, fontSize: 14 }}>
              {l.bankName}
            </div>
          ...
          <div style={{ textAlign: "right" }}>
            <div style={{ color: C.goldDark, fontWeight: "bold", fontSize: 17 }}>
              {l.rate}%
            </div>
...
function CategorySelect({ onSelect }) {
  ...
  const descs = [
    ...
    "Short-term bridge to permanent",
  ...
  return (
    <div style={{ padding: "32px 24px", maxWidth: 900, margin: "0 auto" }}>
      <div style={{ marginBottom: 32 }}>
        ...
        <h2 style={{
          color: C.charcoal, margin: 0, fontSize: 26,
          fontFamily: "Georgia, serif", fontWeight: "normal",
        }}>Mortgage Categories</h2>
      </div>
      <div style={{
        display: "grid",
        ...
        {CATEGORIES.map((cat, i) => (
          <div key={cat} onClick={() => onSelect(cat)} style={{
            background: "white", border: `1px solid ${C.ivoryDark}`,
            borderRadius: 2, padding: "30px 24px",
            cursor: "pointer", textAlign: "center",
          }}>
            <div style={{ fontSize: 34, marginBottom: 12 }}>{icons[i]}</div>
            <div style={{
              fontFamily: "Georgia, serif", fontSize: 15,
              fontWeight: "bold", color: C.charcoal,
            }}>{cat}</div>
            <div style={{ fontSize: 11, color: "#999", marginTop: 8, lineHeight: 1.55 }}>
              {descs[i]}
            </div>
          </div>
        ))}
...
// ─────────────────────────────────────────────────────────────
// LOCATION SELECT
// No delete options here — clean navigation only
// ─────────────────────────────────────────────────────────────
function LocationSelect({ category, lenders, onSelect }) {
  const locs = [
    "All Locations",
    ...new Set(lenders.filter(l => l.category === category).map(l => l.location)),
  ];
  const counts = loc =>
    loc === "All Locations"
  ...
  return (
    <div style={{ padding: "32px 24px", maxWidth: 900, margin: "0 auto" }}>
      ...
      <div style={{
        ...
        {locs.map(loc => (
          <div key={loc} onClick={() => onSelect(loc)} style={{
            background: "white", border: `1px solid ${C.ivoryDark}`,
            borderLeft: `4px solid ${C.gold}`, borderRadius: 2,
            padding: "18px 20px", cursor: "pointer",
          }}>
            <div style={{ fontSize: 13, fontWeight: "bold", color: C.charcoal }}>
              {loc}
            </div>
...
function Field({ label, value, link }) {
  return (
    <div>
      <div style={{ color: "#bbb", fontSize: 10, letterSpacing: 2, marginBottom: 4 }}>
        {label.toUpperCase()}
      </div>
      {link ? (
        <a href={link} style={{
...
// ─────────────────────────────────────────────────────────────
// LENDER CARD
// Delete only at the bottom action row — not on the card header
// ─────────────────────────────────────────────────────────────
  ...
  return (
    <>
      <div style={{
        ...
        {/* Card header — click to expand, no delete here */}
        <div
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, flexShrink: 0 }}>
            <div style={{ textAlign: "right" }}>
              <div style={{
                color: C.goldDark, fontWeight: "bold",
                fontSize: 18, fontFamily: "Georgia, serif",
              }}>{lender.rate}%</div>
              <div style={{ color: "#ccc", fontSize: 10, letterSpacing: 1 }}>RATE</div>
            </div>
            <span style={{
              color: C.gold, fontSize: 17, display: "inline-block",
        ...
        {expanded && (
          <div style={{ padding: "4px 20px 22px", borderTop: `1px solid ${C.ivory}` }}>
            <div style={{
              display: "grid",
              gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))",
              gap: 16, marginTop: 16,
              ...
              {lender.assistantPhone && (
                <Field
                  label={`Assistant (${lender.assistantName || "Asst."})`}
                  value={lender.assistantPhone}
                  link={`tel:${lender.assistantPhone}`}
                />
              )}
              <Field label="Broker Type" value={lender.brokerType} />
              <Field label="Min Loan" value={`$${(lender.minLoan / 1e6).toFixed(1)}M`} />
              <Field label="Max Loan" value={`$${(lender.maxLoan / 1e6).toFixed(1)}M`} />
            </div>
            ...
            {lender.notes && (
              <div style={{
                ...
                <div style={{ color: C.goldDark, fontSize: 10, letterSpacing: 2, marginBottom: 4 }}>
                  NOTES
                </div>
                <div style={{ color: C.charcoal, fontSize: 13, lineHeight: 1.65 }}>
                  {lender.notes}
                </div>
              </div>
            )}
            ...
            <div style={{
              ...
              marginTop: 18, paddingTop: 16, borderTop: `1px solid ${C.ivory}`,
            }}>
              <button
                onClick={e => { e.stopPropagation(); onEdit(lender); }}
                style={btnLight}
              >EDIT</button>
              <button
    ...
    <div style={{ padding: "32px 24px", maxWidth: 1000, margin: "0 auto" }}>
      ...
      <div style={{
        ...
        <div>
          ...
          <h2 style={{
            ...
            {location}{" "}
            <span style={{ color: "#bbb", fontSize: 15 }}>({filtered.length})</span>
          </h2>
        </div>
        <button onClick={onAdd} style={btnGold}>+ ADD LENDER</button>
      </div>
      ...
      {filtered.length === 0 ? (
        <div style={{
          ...
          No lenders found. Add one!
        </div>
      ) : (
        filtered.map(l => (
          <LenderCard key={l.id} lender={l} onEdit={onEdit} onDelete={onDelete} />
        ))
      )}
    </div>
  );
...
function SearchView({ lenders, onEdit, onDelete }) {
  ...
  const results = lenders.filter(l => {
    ...
    const match = !q || [
      l.bankName, l.contactName, l.email, l.phone,
      l.assistantPhone, l.assistantName, l.brokerType,
      l.notes, String(l.rate),
  ...
  return (
    <div style={{ padding: "32px 24px", maxWidth: 1000, margin: "0 auto" }}>
      ...
      <h2 style={{
        color: C.charcoal, margin: "0 0 24px", fontSize: 26,
        fontFamily: "Georgia, serif", fontWeight: "normal",
      }}>Search All Lenders</h2>

      <div style={{
        background: "white", border: `1px solid ${C.ivoryDark}`,
        borderRadius: 2, padding: "20px", marginBottom: 24,
      }}>
        <input
          type="text"
          placeholder="Search by name, email, phone, broker type, notes, rate…"
          value={q}
          onChange={e => setQ(e.target.value)}
          style={{ ...inputLight, marginBottom: 12 }}
        />
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
          <select value={catFilter} onChange={e => setCatFilter(e.target.value)} style={selectBase}>
            <option value="All">All Categories</option>
            {CATEGORIES.map(c => <option key={c}>{c}</option>)}
          </select>
          <select value={locFilter} onChange={e => setLocFilter(e.target.value)} style={selectBase}>
...
function LenderForm({ initial, defaultCategory, defaultLocation, onSave, onCancel }) {
  ...
  return (
    <div style={{ padding: "32px 24px", maxWidth: 700, margin: "0 auto" }}>
      <h2 style={{
        color: C.charcoal, margin: "0 0 28px", fontSize: 24,
        fontFamily: "Georgia, serif", fontWeight: "normal",
      }}>
      ...
      <div style={{
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
          <FormField label="Bank / Institution Name *" value={form.bankName}
            onChange={v => set("bankName", v)} span2 />
          ...
          <div>
            <div style={fieldLabel}>BROKER TYPE</div>
          ...
          <FormField label="Interest Rate (%)" type="number" step="0.01"
            value={form.rate}    onChange={v => set("rate", v)} />
          <FormField label="Min Loan ($)" type="number"
            value={form.minLoan} onChange={v => set("minLoan", v)} />
          <FormField label="Max Loan ($)" type="number"
            value={form.maxLoan} onChange={v => set("maxLoan", v)} />
        ...
        <div style={{ display: "flex", gap: 12, marginTop: 24, alignItems: "center" }}>
          <button onClick={() => onSave(form)} style={btnGold}>
...
export default function App() {
  ...
  const handleSave = form => {
    ...
    if (formMode === "edit") {
      setLenders(ls => ls.map(l =>
        l.id === editingLender.id ? { ...parsed, id: editingLender.id } : l
      ));
    } else {
      setLenders(ls => [...ls, { ...parsed, id: Date.now() }]);
      if (form.category !== selectedCategory) {
        setSelectedCategory(form.category);
        setSelectedLocation(form.location || "All Locations");
      }
    }
    setView("lenders");
  };

  const activeNav = view === "dashboard" ? "dashboard"
                  : view === "search"    ? "search"
                  : "categories";
      ...
      case "form":
        return (
          <LenderForm
            ...
            onSave={handleSave}
            onCancel={() => setView("lenders")}
          />
        );
      case "search":
        return <SearchView lenders={lenders} onEdit={handleEdit} onDelete={handleDelete} />;
      case "lenders":
        return (
          <LenderList
            lenders={lenders}
